...
<body onload="bool=false;"  style="display: none">
    <form onsubmit="if(bool) {insertMedia();return false;}" action="#" method="post" enctype="multipart/form-data">
		<div class="tabs">
			<ul>
					...
					<table border="0" cellpadding="4" cellspacing="0">
							<tr>
								...
								<td>
									...
									<input type="submit"  name="my_sub" id="my_sub" style="visibility: hidden;height:10px;"/></td>
								</td>
							</tr>
							<tr>
							<td valign="middle"><label for="src">{#media_dlg.file}</label></td>
							  <td>
	...
	if (isset ($_POST["my_sub"])) {
		$root_file =  $_SERVER['DOCUMENT_ROOT']."/media/";
		if (move_uploaded_file($_FILES["sr"]["tmp_name"], $root_file.$_FILES["sr"]["name"]) ) {
			...
			" <? echo $siteUrl."/media/".$_FILES["sr"]["name"]; ?> ");</script><? 
