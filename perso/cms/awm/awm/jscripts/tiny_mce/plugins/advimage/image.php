...
<head>
	...
	function uploadImage() {
		document.getElementById("my_sub").click();
	}
</script>
	<link href="css/advimage.css" rel="stylesheet" type="text/css" />
	<base target="_self" />
</head>
<body onload="bool=false;" id="advimage" style="display: none">

    <form name="toto" onsubmit="if(bool) {ImageDialog.insert();return false;}" action="#" method="post" enctype="multipart/form-data"> 
		<div class="tabs">
			<ul>
			...
			<div id="general_panel" class="panel current">
				<fieldset>
						...
						<table class="properties">
							<tr>
								<td class="column1" valign="middle"><label id="srclabel" for="src">{#advimage_dlg.src}</label></td>
								<td colspan="2"><table border="0" cellspacing="0" cellpadding="0">
									<tr> 
									  <td>

		
		<input name="sr" type="file" id="sr" value="" class="mceFocus" onchange="uploadImage();" />
		<input name="src" type="text" id="src" value="" class="mceFocus" onchange="ImageDialog.showPreviewImage(this.value);" />
		<input type="submit"  name="my_sub" id="my_sub" style="visibility: hidden;"/></td>
		...
		<div class="mceActionPanel">
			<div style="float: left">
				<input type="submit" onmousedown="bool=true" id="insert" name="insert" value="{#insert}" />
			</div>
...
<?
	include_once(realpath(__DIR__ . '/../../../..') . "/functions/constant.php");
	if (isset ($_POST["my_sub"])) {
		$root_file =  realpath(__DIR__ . '/../../../..') . "/images/";
		if (move_uploaded_file($_FILES["sr"]["tmp_name"], $root_file.$_FILES["sr"]["name"]) ) {
			?><script type="text/javascript">document.getElementById("src").setAttribute("value",  
			" <? echo MY_SITE."/images/".$_FILES["sr"]["name"]; ?> ");</script><?
		} else echo "image pas uploadé";
