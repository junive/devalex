...
function Cg(){}
_=Cg.prototype=new Cl();_.r=rh;_.w=sh;_.z=th;_.E=uh;_.db=vh;_.fb=xh;_.eb=wh;_.gb=yh;_.ic=zh;_.pc=Ah;_.qc=Bh;_.sc=Ch;_.tc=Dh;_.uc=Eh;_.Dc=gr+'DOMImpl';_.Cc=0;function fh(a,b){return a==b;}
function gh(a){return a.relatedTarget?a.relatedTarget:null;}
function hh(a){return a.relatedTarget||null;}
function ih(a){a.preventDefault();}
function jh(c){var b=0,a=c.firstChild;while(a){if(a.nodeType==1)++b;a=a.nextSibling;}return b;}
function kh(a){var b=a.parentNode;if(b==null){return null;}if(b.nodeType!=1)b=null;return b||null;}
...
function mh(b,a){while(a){if(b==a){return true;}a=a.parentNode;if(a&&a.nodeType!=1){a=null;}}return false;}
function nh(a){if(a==$wnd.__captureElem)$wnd.__captureElem=null;}
function oh(a){$wnd.__captureElem=a;}
...
function dh(){}
_=dh.prototype=new Cg();_.t=fh;_.C=gh;_.D=hh;_.F=ih;_.cb=jh;_.ib=kh;_.ub=lh;_.vb=mh;_.hc=nh;_.oc=oh;_.vc=ph;_.Dc=gr+'DOMImplStandard';_.Cc=0;function Fg(a){return a.pageX-$doc.body.scrollLeft;}
function ah(a){return a.pageY-$doc.body.scrollTop;}
function bh(b){if(b.offsetLeft==null){return 0;}var c=0;var a=b;while(a.offsetParent){c-=a.scrollLeft;a=a.parentNode;}while(b){c+=b.offsetLeft;var d=b.offsetParent;if(d&&(d.tagName=='BODY'&&b.style.position=='absolute')){break;}b=d;}return c;}
function ch(b){if(b.offsetTop==null){return 0;}var d=0;var a=b;while(a.offsetParent){d-=a.scrollTop;a=a.parentNode;}while(b){d+=b.offsetTop;var c=b.offsetParent;if(c&&(c.tagName=='BODY'&&b.style.position=='absolute')){break;}b=c;}return d;}
function Dg(){}
_=Dg.prototype=new dh();_.A=Fg;_.B=ah;_.ab=bh;_.bb=ch;_.Dc=gr+'DOMImplSafari';_.Cc=0;function Dk(a){if(a.b){throw vl(new ul(),"Should only call onAttach when the widget is detached from the browser's document");}a.b=true;qf(a.n,a);}
