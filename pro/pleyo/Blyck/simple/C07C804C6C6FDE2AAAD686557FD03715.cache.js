...
function Eg(b,a){b.appendChild(a);}
function Fg(a){return $doc.createElement(a);}
function ah(b,a){b.cancelBubble=a;}
...
function kg(){}
_=kg.prototype=new aj();_.p=Eg;_.s=Fg;_.t=ah;_.y=bh;_.D=ch;_.F=eh;_.E=dh;_.ab=fh;_.zb=gh;_.Ab=hh;_.Cb=ih;_.Db=jh;_.Eb=kh;_.hc=Fk+'DOMImpl';_.gc=0;function ng(a,b){if(!a&& !b)return true;else if(!a|| !b)return false;return a.uniqueID==b.uniqueID;}
function og(a){return a.clientX-vg();}
function pg(a){return a.clientY-wg();}
function qg(a){return a.fromElement?a.fromElement:null;}
function rg(a){return a.toElement||null;}
function sg(a){a.returnValue=false;}
function tg(a){var b=$doc.documentElement.scrollLeft||$doc.body.scrollLeft;return a.getBoundingClientRect().left+b-vg();}
function ug(a){var b=$doc.documentElement.scrollTop||$doc.body.scrollTop;return a.getBoundingClientRect().top+b-wg();}
function vg(){return $doc.documentElement.clientLeft||$doc.body.clientLeft;}
function wg(){return $doc.documentElement.clientTop||$doc.body.clientTop;}
function xg(a){return a.children.length;}
function yg(){try{$doc.execCommand('BackgroundImageCache',false,true);}catch(a){}this.a={};$wnd.__dispatchEvent=function(){if($wnd.event.returnValue==null){$wnd.event.returnValue=true;if(!Ae($wnd.event))return;}if(this.__listener)je($wnd.event,this,this.__listener);};$wnd.__dispatchDblClickEvent=function(){var a=$doc.createEventObject();this.fireEvent('onclick',a);if(this.__eventBits&2)$wnd.__dispatchEvent.call(this);};$doc.body.onclick=$doc.body.onmousedown=$doc.body.onmouseup=$doc.body.onmousemove=$doc.body.onmousewheel=$doc.body.onkeydown=$doc.body.onkeypress=$doc.body.onkeyup=$doc.body.onfocus=$doc.body.onblur=$doc.body.ondblclick=$wnd.__dispatchEvent;}
function zg(b,a){while(a){if(b.uniqueID==a.uniqueID)return true;a=a.parentElement;}return false;}
function Ag(a){a.releaseCapture();}
function Bg(a){a.setCapture();}
...
function lg(){}
_=lg.prototype=new kg();_.r=ng;_.u=og;_.v=pg;_.w=qg;_.x=rg;_.z=sg;_.A=tg;_.B=ug;_.C=xg;_.hb=yg;_.ib=zg;_.wb=Ag;_.yb=Bg;_.Fb=Cg;_.hc=Fk+'DOMImplIE6';_.gc=0;_.a=null;function mi(b,a){if(b.a){bf(b.n,null);}Fh(b,a);if(b.a){bf(a,b);}}
function ni(a){}
