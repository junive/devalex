...
function kg(){}
_=kg.prototype=new aj();_.p=Eg;_.s=Fg;_.t=ah;_.y=bh;_.D=ch;_.F=eh;_.E=dh;_.ab=fh;_.zb=gh;_.Ab=hh;_.Cb=ih;_.Db=jh;_.Eb=kh;_.hc=Fk+'DOMImpl';_.gc=0;function tg(a,b){return a==b;}
function ug(a){return a.relatedTarget?a.relatedTarget:null;}
function vg(a){return a.relatedTarget||null;}
function wg(a){a.preventDefault();}
function xg(c){var b=0,a=c.firstChild;while(a){if(a.nodeType==1)++b;a=a.nextSibling;}return b;}
function yg(){$wnd.__dispatchCapturedMouseEvent=function(b){if($wnd.__dispatchCapturedEvent(b)){var a=$wnd.__captureElem;if(a&&a.__listener){je(b,a,a.__listener);b.stopPropagation();}}};$wnd.__dispatchCapturedEvent=function(a){if(!Ae(a)){a.stopPropagation();a.preventDefault();return false;}return true;};$wnd.addEventListener('click',$wnd.__dispatchCapturedMouseEvent,true);$wnd.addEventListener('dblclick',$wnd.__dispatchCapturedMouseEvent,true);$wnd.addEventListener('mousedown',$wnd.__dispatchCapturedMouseEvent,true);$wnd.addEventListener('mouseup',$wnd.__dispatchCapturedMouseEvent,true);$wnd.addEventListener('mousemove',$wnd.__dispatchCapturedMouseEvent,true);$wnd.addEventListener('mousewheel',$wnd.__dispatchCapturedMouseEvent,true);$wnd.addEventListener('keydown',$wnd.__dispatchCapturedEvent,true);$wnd.addEventListener('keyup',$wnd.__dispatchCapturedEvent,true);$wnd.addEventListener('keypress',$wnd.__dispatchCapturedEvent,true);$wnd.__dispatchEvent=function(a){if(this.__listener)je(a,this,this.__listener);};$wnd.__captureElem=null;}
function zg(b,a){while(a){if(b==a){return true;}a=a.parentNode;if(a&&a.nodeType!=1){a=null;}}return false;}
function Ag(a){if(a==$wnd.__captureElem)$wnd.__captureElem=null;}
function Bg(a){$wnd.__captureElem=a;}
...
function rg(){}
_=rg.prototype=new kg();_.r=tg;_.w=ug;_.x=vg;_.z=wg;_.C=xg;_.hb=yg;_.ib=zg;_.wb=Ag;_.yb=Bg;_.Fb=Cg;_.hc=Fk+'DOMImplStandard';_.gc=0;function ng(a){return a.pageX-$doc.body.scrollLeft;}
function og(a){return a.pageY-$doc.body.scrollTop;}
function pg(b){if(b.offsetLeft==null){return 0;}var c=0;var a=b;while(a.offsetParent){c-=a.scrollLeft;a=a.parentNode;}while(b){c+=b.offsetLeft;var d=b.offsetParent;if(d&&(d.tagName=='BODY'&&b.style.position=='absolute')){break;}b=d;}return c;}
function qg(b){if(b.offsetTop==null){return 0;}var d=0;var a=b;while(a.offsetParent){d-=a.scrollTop;a=a.parentNode;}while(b){d+=b.offsetTop;var c=b.offsetParent;if(c&&(c.tagName=='BODY'&&b.style.position=='absolute')){break;}b=c;}return d;}
function lg(){}
_=lg.prototype=new rg();_.u=ng;_.v=og;_.A=pg;_.B=qg;_.hc=Fk+'DOMImplSafari';_.gc=0;function mi(b,a){if(b.a){bf(b.n,null);}Fh(b,a);if(b.a){bf(a,b);}}
function ni(a){}
