...
function com_google_gwt_user_client_DOM_$clinit__(){
  ...
  {
    com_google_gwt_user_client_DOM_impl = new com_google_gwt_user_client_impl_DOMImplMozilla();
...
function com_google_gwt_user_client_DOM_getAbsoluteLeft__Lcom_google_gwt_user_client_Element_2(elem){
  com_google_gwt_user_client_DOM_$clinit__();
  return com_google_gwt_user_client_impl_DOMImplMozilla_$getAbsoluteLeft__Lcom_google_gwt_user_client_impl_DOMImplMozilla_2Lcom_google_gwt_user_client_Element_2(com_google_gwt_user_client_DOM_impl, elem);
}

function com_google_gwt_user_client_DOM_getAbsoluteTop__Lcom_google_gwt_user_client_Element_2(elem){
  com_google_gwt_user_client_DOM_$clinit__();
  return com_google_gwt_user_client_impl_DOMImplMozilla_$getAbsoluteTop__Lcom_google_gwt_user_client_impl_DOMImplMozilla_2Lcom_google_gwt_user_client_Element_2(com_google_gwt_user_client_DOM_impl, elem);
}
...
function com_google_gwt_user_client_impl_DOMImplMozilla_$getAbsoluteLeft__Lcom_google_gwt_user_client_impl_DOMImplMozilla_2Lcom_google_gwt_user_client_Element_2(this$static, elem){
  return elem.getBoundingClientRect().x - $doc.documentElement.getBoundingClientRect().x;
}

function com_google_gwt_user_client_impl_DOMImplMozilla_$getAbsoluteTop__Lcom_google_gwt_user_client_impl_DOMImplMozilla_2Lcom_google_gwt_user_client_Element_2(this$static, elem){
  return elem.getBoundingClientRect().y - $doc.documentElement.getBoundingClientRect().y;
}
