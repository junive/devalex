...
function com_google_gwt_user_client_DOM_$clinit__(){
  ...
  {
    com_google_gwt_user_client_DOM_impl = new com_google_gwt_user_client_impl_DOMImplMozillaOld();
    com_google_gwt_user_client_impl_DOMImplMozilla_$init__Lcom_google_gwt_user_client_impl_DOMImplMozilla_2(com_google_gwt_user_client_DOM_impl);
  }
}
...
function com_google_gwt_user_client_DOM_compare__Lcom_google_gwt_user_client_Element_2Lcom_google_gwt_user_client_Element_2(elem1, elem2){
  com_google_gwt_user_client_DOM_$clinit__();
  return com_google_gwt_user_client_impl_DOMImplMozilla_$compare__Lcom_google_gwt_user_client_impl_DOMImplMozilla_2Lcom_google_gwt_user_client_Element_2Lcom_google_gwt_user_client_Element_2(com_google_gwt_user_client_DOM_impl, elem1, elem2);
}
...
function com_google_gwt_user_client_DOM_eventGetClientX__Lcom_google_gwt_user_client_Event_2(evt){
  com_google_gwt_user_client_DOM_$clinit__();
  return com_google_gwt_user_client_impl_DOMImpl_$eventGetClientX__Lcom_google_gwt_user_client_impl_DOMImpl_2Lcom_google_gwt_user_client_Event_2(com_google_gwt_user_client_DOM_impl, evt);
}

function com_google_gwt_user_client_DOM_eventGetClientY__Lcom_google_gwt_user_client_Event_2(evt){
  com_google_gwt_user_client_DOM_$clinit__();
  return com_google_gwt_user_client_impl_DOMImpl_$eventGetClientY__Lcom_google_gwt_user_client_impl_DOMImpl_2Lcom_google_gwt_user_client_Event_2(com_google_gwt_user_client_DOM_impl, evt);
}
...
function com_google_gwt_user_client_DOM_getAbsoluteLeft__Lcom_google_gwt_user_client_Element_2(elem){
  com_google_gwt_user_client_DOM_$clinit__();
  return com_google_gwt_user_client_impl_DOMImplMozillaOld_$getAbsoluteLeft__Lcom_google_gwt_user_client_impl_DOMImplMozillaOld_2Lcom_google_gwt_user_client_Element_2(com_google_gwt_user_client_DOM_impl, elem);
}

function com_google_gwt_user_client_DOM_getAbsoluteTop__Lcom_google_gwt_user_client_Element_2(elem){
  com_google_gwt_user_client_DOM_$clinit__();
  return com_google_gwt_user_client_impl_DOMImplMozillaOld_$getAbsoluteTop__Lcom_google_gwt_user_client_impl_DOMImplMozillaOld_2Lcom_google_gwt_user_client_Element_2(com_google_gwt_user_client_DOM_impl, elem);
}
...
function com_google_gwt_user_client_DOM_isOrHasChild__Lcom_google_gwt_user_client_Element_2Lcom_google_gwt_user_client_Element_2(parent, child){
  com_google_gwt_user_client_DOM_$clinit__();
  return com_google_gwt_user_client_impl_DOMImplMozilla_$isOrHasChild__Lcom_google_gwt_user_client_impl_DOMImplMozilla_2Lcom_google_gwt_user_client_Element_2Lcom_google_gwt_user_client_Element_2(com_google_gwt_user_client_DOM_impl, parent, child);
}
...
function com_google_gwt_user_client_DOM_releaseCapture__Lcom_google_gwt_user_client_Element_2(elem){
  ...
  com_google_gwt_user_client_impl_DOMImplMozilla_$releaseCapture__Lcom_google_gwt_user_client_impl_DOMImplMozilla_2Lcom_google_gwt_user_client_Element_2(com_google_gwt_user_client_DOM_impl, elem);
}
...
function com_google_gwt_user_client_DOM_sinkEvents__Lcom_google_gwt_user_client_Element_2I(elem, eventBits){
  com_google_gwt_user_client_DOM_$clinit__();
  com_google_gwt_user_client_impl_DOMImplMozilla_$sinkEvents__Lcom_google_gwt_user_client_impl_DOMImplMozilla_2Lcom_google_gwt_user_client_Element_2I(com_google_gwt_user_client_DOM_impl, elem, eventBits);
}
...
function com_google_gwt_user_client_impl_DOMImpl_$eventGetClientX__Lcom_google_gwt_user_client_impl_DOMImpl_2Lcom_google_gwt_user_client_Event_2(this$static, evt){
  return evt.clientX || -1;
}

function com_google_gwt_user_client_impl_DOMImpl_$eventGetClientY__Lcom_google_gwt_user_client_impl_DOMImpl_2Lcom_google_gwt_user_client_Event_2(this$static, evt){
...
_.java_lang_Object_typeId$ = 0;
function com_google_gwt_user_client_impl_DOMImplMozilla_$compare__Lcom_google_gwt_user_client_impl_DOMImplMozilla_2Lcom_google_gwt_user_client_Element_2Lcom_google_gwt_user_client_Element_2(this$static, elem1, elem2){
  if (!elem1 && !elem2) {
    return true;
  }
   else if (!elem1 || !elem2) {
...
function com_google_gwt_user_client_impl_DOMImplMozilla_$init__Lcom_google_gwt_user_client_impl_DOMImplMozilla_2(this$static){
  com_google_gwt_user_client_impl_DOMImplStandard_$init__Lcom_google_gwt_user_client_impl_DOMImplStandard_2(this$static);
  com_google_gwt_user_client_impl_DOMImplMozilla_$initMozilla__Lcom_google_gwt_user_client_impl_DOMImplMozilla_2(this$static);
}

function com_google_gwt_user_client_impl_DOMImplMozilla_$initMozilla__Lcom_google_gwt_user_client_impl_DOMImplMozilla_2(this$static){
...
function com_google_gwt_user_client_impl_DOMImplMozilla_$isOrHasChild__Lcom_google_gwt_user_client_impl_DOMImplMozilla_2Lcom_google_gwt_user_client_Element_2Lcom_google_gwt_user_client_Element_2(this$static, parent, child){
  while (child) {
...
function com_google_gwt_user_client_impl_DOMImplMozilla_$releaseCapture__Lcom_google_gwt_user_client_impl_DOMImplMozilla_2Lcom_google_gwt_user_client_Element_2(this$static, elem){
  if (elem.isSameNode($wnd.__captureElem)) {
    $wnd.__captureElem = null;
  }
}

function com_google_gwt_user_client_impl_DOMImplMozilla_$sinkEvents__Lcom_google_gwt_user_client_impl_DOMImplMozilla_2Lcom_google_gwt_user_client_Element_2I(this$static, elem, bits){
  com_google_gwt_user_client_impl_DOMImplStandard_$sinkEvents__Lcom_google_gwt_user_client_impl_DOMImplStandard_2Lcom_google_gwt_user_client_Element_2I(this$static, elem, bits);
  com_google_gwt_user_client_impl_DOMImplMozilla_$sinkEventsMozilla__Lcom_google_gwt_user_client_impl_DOMImplMozilla_2Lcom_google_gwt_user_client_Element_2I(this$static, elem, bits);
}

function com_google_gwt_user_client_impl_DOMImplMozilla_$sinkEventsMozilla__Lcom_google_gwt_user_client_impl_DOMImplMozilla_2Lcom_google_gwt_user_client_Element_2I(this$static, elem, bits){
  if (bits & 131072) {
    elem.addEventListener('DOMMouseScroll', $wnd.__dispatchEvent, false);
  }
}

function com_google_gwt_user_client_impl_DOMImplMozilla(){
}

_ = com_google_gwt_user_client_impl_DOMImplMozilla.prototype = new com_google_gwt_user_client_impl_DOMImplStandard();
_.java_lang_Object_typeId$ = 0;
function com_google_gwt_user_client_impl_DOMImplMozillaOld_$getAbsoluteLeft__Lcom_google_gwt_user_client_impl_DOMImplMozillaOld_2Lcom_google_gwt_user_client_Element_2(this$static, elem){
  var style = $doc.defaultView.getComputedStyle(elem, null);
  var left = elem.getBoundingClientRect().x - Math.round(style.getPropertyCSSValue('border-left-width').getFloatValue(CSSPrimitiveValue.CSS_PX));
  var parent = elem.parentNode;
  while (parent) {
...
function com_google_gwt_user_client_impl_DOMImplMozillaOld_$getAbsoluteTop__Lcom_google_gwt_user_client_impl_DOMImplMozillaOld_2Lcom_google_gwt_user_client_Element_2(this$static, elem){
  var style = $doc.defaultView.getComputedStyle(elem, null);
  var top = elem.getBoundingClientRect().y - Math.round(style.getPropertyCSSValue('border-top-width').getFloatValue(CSSPrimitiveValue.CSS_PX));
  var parent = elem.parentNode;
  while (parent) {
...
function com_google_gwt_user_client_impl_DOMImplMozillaOld(){
}

_ = com_google_gwt_user_client_impl_DOMImplMozillaOld.prototype = new com_google_gwt_user_client_impl_DOMImplMozilla();
_.java_lang_Object_typeId$ = 0;
