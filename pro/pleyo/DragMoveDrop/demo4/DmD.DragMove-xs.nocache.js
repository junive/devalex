function DmD_DragMove(){
  ...
  function maybeStartModule(){
    if (gwtOnLoad && bodyDone) {
      gwtOnLoad(onLoadErrorFunc, 'DmD.DragMove', base);
    }
  }

  function computeScriptBase(){
    var thisScript, markerScript;
    $doc.write('<script id="__gwt_marker_DmD.DragMove"><\/script>');
    markerScript = $doc.getElementById('__gwt_marker_DmD.DragMove');
    if (markerScript) {
  ...
  DmD_DragMove.onScriptLoad = function(gwtOnLoadFunc){
    DmD_DragMove = null;
