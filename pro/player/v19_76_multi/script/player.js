...
document.addEventListener("DOMContentLoaded", function(event) {
	...
	player10 =  myHtml.getPlayer(playerBox);
	player11 =  myHtml.getPlayer(playerBox);
	...
	myEvent.attach(menu, player10);
	myEvent.attach(menu, player11);
	
	myEvent.attach(menuControl, menu);
	myEvent.attach(playerControl, player);
	myEvent.attach(playerControl, player10);
	myEvent.attach(playerControl, player11);
