...
$titre="Réservation";
$numMenu=10;
//On affiche le manu de gauche, la bannière et les photos au centre
...
<table>
	<tr><td  width="350" align="center" valign="top">
				...
				<?  
					...
					$temp=$i+1;
				 	echo "<u>Chambre $temp </u> : Adultes :<select style='margin:0;padding:0;' onchange='submit()' name='nombreAdulteCham$i'>" ;
					$nbAdulte=0;
...
?>
	...
	<script  type="text/javascript">
		...
		function annuler()
		{
			window.location.href = "<? echo "$siteUrl . $europellier"; ?>";
		}
	</script>
...
<? //On affiche les informations de droite 
