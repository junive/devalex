...
<tr>
       	<td style=" background-color:#ffcc00;" align="center" valign="center" colspan="8" width="499" height="449" >
				...
				Cliquer sur le plan pour élargir la zone (ou imprimer).<br />
				  ...
				  Zoom : <a style="color:#00CCCC; text-decoration:none" href="Plan.php">Quartier</a> - <a class="zoom" href="Plan1.php">Nord Ville</a> - <a class="zoom" href="Plan2.php">Ville</a> - <a class="zoom" href="Plan3.php">Région</a> 
