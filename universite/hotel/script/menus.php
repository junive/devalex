...
function menuClass($num, $url, $titre, $numMenu)
	{
		...
		echo " <td width=\"130\" height=\"20\" class=\"Menu\" > \n";
			...
			if ($num==0)
			{
				echo " <a class=\"menus\" href=\"".$siteUrl . $europellier."/$url.php\">$titre </a>\n ";
			}
			//Sinon, on change la direction
			else
			{
				echo " <a class=\"menus\" href=\"".$siteUrl . $europellier."/Montpellier_Hotel/$url.php\">$titre </a>\n ";}
				echo " </td> </tr> \n";
			}
		...
		echo " </td> ";
		echo " <td width=\"130\"  height=\"20\" class=\"Menu\" > \n";	
		echo " <a style=\"color:#fdbc37;\" class=\"menus\" href=\"$url.php\">$titre</a> \n" ;		
		}
	}	
