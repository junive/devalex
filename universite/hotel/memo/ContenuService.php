...
<? for($i=0;$i<$cptService;$i++)
{echo "<tr><td><input style='margin:0;padding:0;text-align:justify' type='text' value=\"$ContService[$i]\" name=\"indNom$i\" id=\"indexNom$i\" size='60'></td></tr>";}
?>
...
if (isset($_POST['modif'])) 
{
	for ($i=0;$i<$cptService;$i++)
	{
	//--block--$requete="UPDATE eur_ContenuService Set nomContService='${'indNom'.$i}' WHERE numContService=$i";
...
window.location.href="ContenuService.php"</script>
<?
} ?>
