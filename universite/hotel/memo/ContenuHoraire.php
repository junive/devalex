...
<? for($i=0;$i<$cptHoraire;$i++)
{if ($numContHoraire[$i]==4)echo "<tr><td><Textarea rows='4' cols='45' style='margin:0;padding:0;text-align:justify'  name=\"indNom$i\" id=\"indexNom$i\" >$ContHoraire[$i]</textarea></td></tr>";
	else echo "<tr><td><input style='margin:0;padding:0;text-align:justify' type='text' value=\"$ContHoraire[$i]\" name=\"indNom$i\" id=\"indexNom$i\" size='60'></td></tr>";}
?>
...
if (isset($_POST['modif'])) 
{
	for ($i=0;$i<$cptHoraire;$i++)
	{
	//--block--$requete="UPDATE eur_ContenuHoraire Set nomContHoraire='${'indNom'.$i}' WHERE numContHoraire=$i";
...
window.location.href="ContenuHoraire.php"</script>
<?
} ?>
