...
<title>Contenu de la Description </title>
...
Description et mots clés pour les moteurs de recherches
		</td>
	</tr>
<br><br>
...
<? for($i=0;$i<$cptMeta;$i++)
{
echo "<tr><td><span style='accueil'> $nomMeta[$i] </span><Textarea rows='4' cols='45' style='margin:0;padding:0;text-align:justify'  name=\"indNom$i\" id=\"indexNom$i\" >$ContMeta[$i]</textarea></td></tr>";}
?>
...
if (isset($_POST['modif'])) 
{
	for ($i=0;$i<$cptMeta;$i++)
	{
	//--block--$requete="UPDATE eur_MetaTag Set ContMeta='${'indNom'.$i}' WHERE numMeta=$i";
...
window.location.href="ContenuDescrip.php"</script>
<?
} ?>
