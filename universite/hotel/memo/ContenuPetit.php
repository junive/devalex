...
<title>Contenu Petit Dejeuner</title>
...
for($i=0;$i<$cptPetit;$i++)
{ if ($numContPetit[$i]==4)echo "<tr><td><Textarea rows='8' cols='45' style='margin:0;padding:0;text-align:justify'  name=\"indNom$i\" id=\"indexNom$i\" >$ContPetit[$i]</textarea></td></tr>";
	else echo "<tr><td><input style='margin:0;padding:0;text-align:justify' type='text' value=\"$ContPetit[$i]\" name=\"indNom$i\" id=\"indexNom$i\" size='60'></td></tr>";}
?>
...
if (isset($_POST['modif'])) 
{
	for ($i=0;$i<$cptPetit;$i++)
	{
	//--block--$requete="UPDATE eur_ContenuPetit Set nomContPetit='${'indNom'.$i}' WHERE numContPetit=$i";
...
window.location.href="ContenuPetit.php"</script>
<?
} ?>
