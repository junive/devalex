...
<title>Contenu des conditions générales</title>
...
<? for($i=0;$i<$cptCondition;$i++)
{echo "<tr><td><Textarea rows='22' cols='80' style='margin:0;padding:0;text-align:justify'  name=\"indNom$i\" id=\"indexNom$i\" >$ContCondition[$i]</textarea></td></tr>";}
?>
...
if (isset($_POST['modif'])) 
{
	for ($i=0;$i<$cptCondition;$i++)
	{
	//--block--$requete="UPDATE eur_ContenuConditions Set nomContCondition='${'indNom'.$i}' WHERE numContCondition=$i";
...
window.location.href="ContenuConditions.php"</script>
<?
} ?>
