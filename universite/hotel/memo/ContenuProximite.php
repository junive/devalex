...
<? for($i=0;$i<$cptProximite;$i++)
{echo "<tr><td><Textarea rows='4' cols='45' style='margin:0;padding:0;text-align:justify'  name=\"indNom$i\" id=\"indexNom$i\" >$ContProximite[$i]</textarea></td></tr>";}
?>
...
if (isset($_POST['modif'])) 
{
	for ($i=0;$i<$cptProximite;$i++)
	{
	//--block--$requete="UPDATE eur_ContenuProximite Set nomContProximite='${'indNom'.$i}' WHERE numContProximite=$i";
...
window.location.href="ContenuProximite.php"</script>
<?
} ?>
