...
<? for($i=0;$i<$cptContact;$i++)
{echo "<tr><td><input style='margin:0;padding:0;text-align:justify' type='text' value=\"$ContContact[$i]\" name=\"indNom$i\" id=\"indexNom$i\" size='60'></td></tr>";}
?>
...
if (isset($_POST['modif'])) 
{
	for ($i=0;$i<$cptContact;$i++)
	{
	//--block--$requete="UPDATE eur_ContenuContact Set nomContContact='${'indNom'.$i}' WHERE numContContact=$i";
...
window.location.href="ContenuContact.php"</script>
<?
} ?>
