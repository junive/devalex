...
<title>Contenu TArifs Encadrée</title>
...
<? for($i=0;$i<$cptTar;$i++)
{echo "<tr><td><input style='margin:0;padding:0;text-align:justify' type='text' value=\"$nomTar[$i]\" name=\"indNom$i\" id=\"indexNom$i\" size='60'></td></tr>";}
?>
...
if (isset($_POST['modif'])) 
{
	for ($i=0;$i<$cptTar;$i++)
	{
	//--block--$requete="UPDATE eur_ContenuTarif Set nomContTarif='${'indNom'.$i}' WHERE numContTarif=$i";
...
window.location.href="ContenuTar.php"</script>
<?
} ?>
