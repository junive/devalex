...
<title>Hotel Du Parc Euromedecine de Montpellier : Rooms</title>
						...
						<tr>
							...
							<? for ($i=0;$i<$cptEng;$i++)
								{	
									if ($nomEng[$i]=="Chambre")
									{
									if ($numEng[$i]==14) echo "<u>$ContEng[$i]</u><br />";
									else if ($numEng[$i]==23||$numEng[$i]==32) echo "<br /><u> $ContEng[$i]</u><br />";
									else if ($ContEng[$i]!="") echo " <img src='".$siteUrl . $europellier."/image/point2.gif' alt='' /> $ContEng[$i]<br />";
									}
								}
							?>
