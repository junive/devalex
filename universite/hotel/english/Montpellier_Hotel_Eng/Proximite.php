...
<title>Hotel Du Parc Euromedecine de Montpellier : A proximité</title>
       			...
       			<td style=" background-color:#ffcc00;" align="center" valign="top" colspan="8" width="499" height="449" >
					<table cellpadding="0" cellspacing="0">
						<tr>
							...
							<? 
							echo "<u>$ContEng[121] </u><br /><br />" ; 
							for ($i=122;$i<136;$i++)
							{		
								 if ($numEng[$i]==130) echo "<br />";
								 if ($ContEng[$i]!="") echo "<img src='".$siteUrl . $europellier."/image/point2.gif' alt='' /> $ContEng[$i]<br />"; 
							}
							?>
