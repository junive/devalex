...
<title>Hotel Du Parc Euromedecine de Montpellier : Visit Montpellier</title>
       			...
       			<td style=" background-color:#ffcc00;" align="center" valign="top" colspan="8" width="499" height="449" >
					<table width="460">
						<tr>
							...
							<? for ($i=90;$i<105;$i++)
								{	
									if ($numEng[$i]==90) echo "<u>$ContEng[$i]</u><br />";
									else if ($numEng[$i]==99) echo "<br /><u>$ContEng[$i]</u><br />";
