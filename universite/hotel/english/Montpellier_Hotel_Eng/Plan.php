...
<tr>
       	<td style=" background-color:#ffcc00;" align="center" valign="center" colspan="8" width="499" height="449" >
				...
				Click on the plan to get a larger view (or to print).<br />
				  <a onclick="javascript:popup('<? echo $siteUrl . $europellier; ?>/image/plan/planMoyen.gif')"><img src="<? echo $siteUrl . $europellier; ?>/image/plan/planPetit.gif" border="0" /></a><br /> 
				  Zoom : <a style="color:#00CCCC; text-decoration:none" href="Plan.php">Local area </a> - <a class="zoom" href="Plan1.php">North of Montpellier</a> - <a class="zoom" href="Plan2.php">Montpellier</a> - <a class="zoom" href="Plan3.php">Region</a> 
