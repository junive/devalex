...
<tr>
       	<td style=" background-color:#ffcc00;" align="center" valign="center" colspan="8" width="499" height="449" >
				...
				Click on the plan to get a larger view (or to print).<br />
				  <a onclick="javascript:popup('<? echo $siteUrl . $europellier; ?>/image/plan/planMoyen3.gif')"><img src="<? echo $siteUrl . $europellier; ?>/image/plan/planPetit3.gif" border="0" /></a><br /> 
				  Zoom : <a class="zoom" href="Plan.php">Local area </a> - <a class="zoom" href="Plan1.php">North of Montpellier</a> - <a class="zoom" href="Plan2.php">Montpellier</a> - <a  style="color:#00CCCC; text-decoration:none" href="Plan3.php">Region</a> 
